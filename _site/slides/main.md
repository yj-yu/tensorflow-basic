...
### .x-small[https://github.com/yjyu/tensorflow-basic]
### .x-small[https://yjyu.github.io/tensorflow-basic]
...
```python
git clone https://github.com/yjyu/tensorflow-basic.git
```

code(https://github.com/yjyu/tensorflow-basic)
...
Code(https://https://github.com/yjyu/tensorflow-basic)
